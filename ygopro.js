...
(function() {
  var Struct, data, declaration, field, fs, i, key, lang, len, loadJSON, name, ref, result, structs_declaration, text, type, typedefs;
  ...
  this.stoc_send_chat = function(client, msg, player = 8) {
    ...
    ref1 = (msg != null ? String(msg).split(/\r\n?|\n/) : []);
